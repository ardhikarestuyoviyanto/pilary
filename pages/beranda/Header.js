                ...
                <div className="flex" style={{height:"34rem"}}>
                    <div className="lg:w-1/2 lg:mt-24">
                        ...
                        <p className="text-gray-700 lg:text-xl sm:text-base">
                            ...
                            <br/>
                            <a href="https://api.whatsapp.com/send?phone=081326810290" type="button" className="bg-blue-600 mt-5 p-3 text-white rounded-md transition duration-500 ease-in-out hover:bg-blue-700 transform hover:-translate-y-1 hover:scale-110">
